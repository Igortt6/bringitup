...
/* harmony import */ var _modules_sliders_showInfo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/sliders/showInfo */ "./src/js/modules/sliders/showInfo.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var moduleSlider = new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next',
    btnNextSmall: '.nextmodule',
    btnPrevSmall: '.prevmodule'
  });
  moduleSlider.render();
  ...
  new _modules_sliders_showInfo__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus__content').init();
...
/***/ "./src/js/modules/sliders/showInfo.js":
/*!********************************************!*\
  !*** ./src/js/modules/sliders/showInfo.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./slider */ "./src/js/modules/sliders/slider.js");
...
function (_Slider) {
  ...
  function MainSlider(btns) {
    ...
    var animationDuration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '200';
    var btnNextSmall = arguments.length > 2 ? arguments[2] : undefined;
    var btnPrevSmall = arguments.length > 3 ? arguments[3] : undefined;

    _classCallCheck(this, MainSlider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, btnNextSmall, btnPrevSmall));
    _this.duration = animationDuration;
    _this.start = 0;
    return _this;
  }
  ...
  _createClass(MainSlider, [{
    ...
    key: "animateSlide",
    value: function animateSlide(slide, start) {
      var _this3 = this;
      ...
      if (slide.style.opacity >= 1) {} else {
        requestAnimationFrame(function () {
          return _this3.animateSlide(slide, start);
        });
      }
    }
  }, {
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (item) {
        ...
        item.parentNode.previousElementSibling.addEventListener('click', function (e) {
          e.preventDefault();
          _this4.slidesIndex = 1;

          _this4.showSlides(_this4.slidesIndex);
        });
      });
      this.btnPrevSmall.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
      ...
      this.btnNextSmall.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$btnNextSmall = _ref.btnNextSmall,
      btnNextSmall = _ref$btnNextSmall === void 0 ? null : _ref$btnNextSmall,
      _ref$btnPrevSmall = _ref.btnPrevSmall,
      btnPrevSmall = _ref$btnPrevSmall === void 0 ? null : _ref$btnPrevSmall,
